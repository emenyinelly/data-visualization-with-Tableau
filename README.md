...
In this checkpoint, we are going to work on the 'Earthquakes' dataset that was provided by Kaggle.

Dataset description: This dataset contains earthquakes records between 1/1/2001 and 1/1/2023 worldwide.

➡️ Dataset link(https://drive.google.com/file/d/1-SPZyvLc97ldTd1D-AArBFR-USNuWpxT/view?usp=sharing)

https://i.imgur.com/akUMp35.jpg
...
Sign up for a Tableau public account from here to save your work.
If you already have a Tableau public account you can work directly from the browser interface since a cloud-based version is available for free.
